# CS2-Bot-Randomizer
CS2-Bot-Randomizer is a plugin based on CounterStrikeSharp that allows each bot to have their own knife, gloves, weapon skins, agent model, music kit, stickers, charms and avatar.
# Features
